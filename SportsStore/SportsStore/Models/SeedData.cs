        ...
        public static void EnsurePopulated(IServiceProvider services)
        {
            ...
            if(!context.Products.Any())
            {
                context.Products.AddRange(
                    ...
                    new Product { Name = "Soccer  ball", Description = "FIFA_approved size and weight", Category = "Soccer", Price = 19.50M },
                    new Product { Name = "Corner Flags", Description = "Give you playing field a professional touch", Category = "Soccer", Price = 34.95M },
                    ...
                    new Product { Name = "Unsteady Chair", Description = "Secretly give your opponent a disvantage", Category = "Chess", Price = 29.95M},
